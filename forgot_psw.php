...
<form>
  <div class="container">
          ...
          <button type="submit" class="registerbtn btn btn-success" id="forgot_register" onclick="return forgot_psw_now(event)">Save Password</button>

          <button type="cancle" class="registerbtn btn btn-success" id="forgot_cancle" onclick="return forgot_psew_update_cancle(event)">Cancle</button>
        </div>
